                        ...
                        {paginatedResults.map((result) => (
                            <li key={result.uid} className="result-item">
                                ...
                                <div className="result-buttons">
                                    ...
                                    <button onClick={() => handleViewOnNCBI(result.uid)} className="genbank-button view-ncbi-button">
                                        View on NCBI
                                    </button>
                                    {result.from && result.to && (
                                    ...
                                    <button onClick={() => handleSaveSequence(result.caption, result.title)} className="genbank-button">
                                        Save Sequence
                                    </button>
                                    <button onClick={() => handleRunBlast(result.caption)} className="genbank-button">
                                        Run BLAST
                                    </button>
                                </div>
                            </li>
