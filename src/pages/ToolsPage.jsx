...
const tools = [
  ...
  { name: 'Phylogenetic Analysis', description: 'Construct phylogenetic trees', icon: GitBranch, path: '/phylo' },
  { name: 'Protein Structure', description: 'Predict 3D structure of proteins', icon: Box, path: '/protein' },
